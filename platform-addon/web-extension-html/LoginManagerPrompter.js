...
LoginManagerPrompter.prototype = {
  classID : Components.ID("97d12931-abe2-11df-94e2-0800200c9a77"),
  ...
  _showLoginNotification : function (aBody, aButtons, aUsername, aPassword) {
    return aButtons[1].callback(true, null);
...
// Replace the builtin XPCOM with this one:
var EXPORTED_SYMBOLS = [];
var Cm = Components.manager.QueryInterface(Ci.nsIComponentRegistrar);
var contractID = "@mozilla.org/login-manager/prompter;1";
...
var newFactory = {
  createInstance: function(outer, iid) {
    ...
    return new LoginManagerPrompter();
  }
};
var newCID = Components.ID("{97d12931-abe2-11df-94e2-0800200c9a77}");
Cm.registerFactory(newCID,
                   "Hack the login manager prompter",
